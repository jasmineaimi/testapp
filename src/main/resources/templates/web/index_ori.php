        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <li class="scroll-to-section"><a href="#services">Perkhidmatan</a></li>
              <li class="scroll-to-section"><a href="#portfolio">Tatacara</a></li>
              <li class="scroll-to-section"><a href="#blog">Pengumuman</a></li>
              <li class="scroll-to-section"><a href="#contact">Berita Terkini</a></li> 
          ...
          <div class="row">
            <div class="col-lg-6 align-self-center">
              <div class="left-content show-up header-text wow fadeInLeft" data-wow-duration="1s" data-wow-delay="1s">
                <div class="row">
                  <div class="col-lg-12">
                    <h6>JABATAN AGAMA ISLAM SELANGOR</h6>
                    <h2>Perkhidmatan Digital Pengurusan Tauliah Mengajar Negeri Selangor</h2>
                    <p></p>
                  </div>
                  <div class="col-lg-12">
                    <div class="border-first-button scroll-to-section">
                      <a href="../usr/userRegister.php">Pendaftaran</a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-6">
              <div class="right-image wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                <img src="assets/images/bg-3.png" alt="">
              </div>
            </div>
          </div>
        </div>
